...
#define MOUSE_WHEEL_RADIUS_BIAS_MM      0.0f       // TODO: bias needed to match odometry with reality
#define MOUSE_WHEEL_RADIUS_MM           (30.0f + MOUSE_WHEEL_RADIUS_BIAS_MM)
...
#define KEEP_FRONT_DISTANCE_TOLERANCE_MM   1
#define KEEP_FRONT_DISTANCE_TOLERANCE_UM   ((int32_t) (KEEP_FRONT_DISTANCE_TOLERANCE_MM * MICROMETERS_PER_MILLIMETER))

#define CORRECT_FRONT_DISTANCE_BIAS_MM     -10
#define CORRECT_FRONT_DISTANCE_BIAS_UM     ((int32_t) CORRECT_FRONT_DISTANCE_BIAS_MM * MICROMETERS_PER_MILLIMETER)

#define SHIFT_AFTER_180_DEG_TURN_MM        5.0f
#define SHIFT_AFTER_180_DEG_TURN_UM        ((int32_t) (SHIFT_AFTER_180_DEG_TURN_MM * MICROMETERS_PER_MILLIMETER))

#define SHIFT_DISTANCE_MM                  10
#define SHIFT_DISTANCE_UM                  ((int32_t) (SHIFT_DISTANCE_MM * MICROMETERS_PER_MILLIMETER))
